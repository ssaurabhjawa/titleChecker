...
vendor_dropdown.grid(row=3, column=0, padx=5, pady=5, sticky="w")
...
option_name_label.grid(row=2, column=2, padx=5, pady=1, sticky="w")
option_name_dropdown.grid(row=3, column=2, padx=5, pady=1, sticky="w")

option_value_label = tk.Label(root, text="Option Value:")
option_value_entry = tk.Entry(root, textvariable=option_value_var)
option_value_label.grid(row=2, column=3, padx=5, pady=1, sticky="w")
option_value_entry.grid(row=3, column=3, padx=5, pady=1, sticky="w")
